...
図解では、この前提と照らして **AIの発展・活用に伴うリスク** と **受講生・契約先への伝え方** が読み取れるようにしています（ルールの詳細は `.claude/skills/diagram-personal/SKILL.md`）。
...
パーソナル図解スキルが有効な環境では、チャット欄で **「開始」** と入力すると、**AIリスクと対処**の整理のためのリサーチから図解 HTML 生成・surge.sh デプロイまで進みます。**競合調査は行いません**（手順の詳細は `.claude/skills/diagram-personal/SKILL.md`）。
